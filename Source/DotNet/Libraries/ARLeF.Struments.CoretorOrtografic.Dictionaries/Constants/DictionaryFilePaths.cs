...
namespace ARLeF.Struments.CoretorOrtografic.Dictionaries.Constants
{
    ...
    {
        public static readonly string BERKELEYDB_ELISIONS_FILE_PATH = "Dictionaries/Elisions/BerkeleyDB/elisions.db";
        public static readonly string BERKELEYDB_ERRORS_FILE_PATH = "Dictionaries/Errors/BerkeleyDB/errors.db";
